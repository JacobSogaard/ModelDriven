 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.dslproject.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.dslproject.impl.EntityImpl#getExample <em>Example</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityImpl extends AgentImpl implements Entity
{
  ...
  {
    return DslprojectPackage.Literals.ENTITY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslprojectPackage.ENTITY__NAME, oldName, name));
  }
  ...
  public EList<EntityExample> getExample()
  {
    if (example == null)
    {
      example = new EObjectContainmentEList<EntityExample>(EntityExample.class, this, DslprojectPackage.ENTITY__EXAMPLE);
    }
    return example;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslprojectPackage.ENTITY__EXAMPLE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslprojectPackage.ENTITY__NAME:
        return getName();
      case DslprojectPackage.ENTITY__EXAMPLE:
        return getExample();
    }
