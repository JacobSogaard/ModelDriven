...
@Singleton
public class MyMathGrammarAccess extends AbstractGrammarElementFinder {
	
	public class MathExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyMath.MathExp");
	...
	public class ExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyMath.Exp");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FactorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyMath.Factor");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyMath.Primary");
	...
	public class ParenthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyMath.Parenthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyMath.Number");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public MyMathGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.mydsl.MyMath".equals(grammar.getName())) {
				return grammar;
			}
