 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.dslproject.impl.ModelImpl#getAgent <em>Agent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return DslprojectPackage.Literals.MODEL;
  }
  ...
  public EList<Agent> getAgent()
  {
    if (agent == null)
    {
      agent = new EObjectContainmentEList<Agent>(Agent.class, this, DslprojectPackage.MODEL__AGENT);
    }
    return agent;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslprojectPackage.MODEL__AGENT:
