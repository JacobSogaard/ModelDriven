 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.dslproject.impl.TrainingImpl#getTrainingref <em>Trainingref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrainingImpl extends MinimalEObjectImpl.Container implements Training
{
  ...
  {
    return DslprojectPackage.Literals.TRAINING;
  }
  ...
  public EList<TrainingRef> getTrainingref()
  {
    if (trainingref == null)
    {
      trainingref = new EObjectContainmentEList<TrainingRef>(TrainingRef.class, this, DslprojectPackage.TRAINING__TRAININGREF);
    }
    return trainingref;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslprojectPackage.TRAINING__TRAININGREF:
